...
let number: number = Number(prompt("숫자를 입력 하세요"));
...
let userPw: string | number = "1234qwe";

function loginUser(): void {
  let inputID: string = prompt("ID입력");
  let inputPw: string = prompt("PW입력");
...
//배열내 숫자 합 구하기
let numberArr: number[] = [90, 50, 30, 20, 11];
let sumArr: number = 0;
...
let 숫자: number = 10000;
let 숫자2: number = Number(prompt("숫자몇 ?"));
